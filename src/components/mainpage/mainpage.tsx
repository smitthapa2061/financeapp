        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-400 text-lg mb-8 max-w-2xl mx-auto">
              Contact us on WhatsApp for subscription inquiries and support
            </p>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-flex items-center gap-3 bg-gradient-to-r from-green-500 to-green-600 text-white px-8 py-4 rounded-lg font-bold text-lg shadow-lg hover:shadow-green-500/25 transition-all duration-300 border border-green-500"
            >
